...
\begin{tikzpicture}
    ...
    \node at (axis cs:3.5,2.5) {$\lim_{x \to 2^{-}} f(x) = 2$};
    \node at (axis cs:3.5,1.8) {$\lim_{x \to 2^{+}} f(x) = 3$};
    \node at (axis cs:3.5,1.1) {$\therefore \lim_{x \to 2} f(x)$ no existe};
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \node[blue] at (axis cs:2.5,-6) {Asíntota vertical: $x = 2$};
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \node[blue] at (axis cs:3,2.5) {Asíntota horizontal: $y = 2$};
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \node[blue] at (axis cs:4,6.5) {Discontinuidad removible en $(3, 6)$};
...
\begin{tikzpicture}
    ...
    \node[blue] at (axis cs:1.8,0.35) {$\lim_{x \to 0} f(x) = \frac{1}{4}$};
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \node[blue] at (axis cs:3.5,6) {Función continua en $x = 2$};
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \node[blue] at (axis cs:15,1.8) {Asíntota horizontal: $y = \frac{3}{2}$};
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \node[blue] at (axis cs:3,8) {Asíntota vertical};
    \node[blue] at (axis cs:3,7) {$x = 2$};
    \draw[green!60!black, ->, very thick] (axis cs:2.3,5) -- (axis cs:2.05,8);
    \node[green!60!black] at (axis cs:2.8,5) {$\lim_{x \to 2^{+}} f(x) = +\infty$};
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \node[blue] at (axis cs:1,3.8) {$\lim_{x \to 0} \frac{\sin(3x)}{x} = 3$};
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \addplot[blue, thick, domain=1:4] {2*x - 0.5};
    \addplot[green!60!black, only marks, mark size=3pt] coordinates {(2,3)};
    \draw[green!60!black, dashed] (axis cs:2,0) -- (axis cs:2,3);
    \node[red] at (axis cs:4,8.5) {$y = f(x)$};
    \node[blue] at (axis cs:4,6.5) {Recta tangente};
    \node[green!60!black] at (axis cs:2.5,3.5) {$(a, f(a))$};
    \end{axis}
\end{tikzpicture}
\end{center}
