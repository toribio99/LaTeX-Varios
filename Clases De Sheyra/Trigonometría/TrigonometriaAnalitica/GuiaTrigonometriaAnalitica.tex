...
\begin{tikzpicture}[scale=3]
    ...
    \draw[red,thick] (P |- 0,0) -- (P) node[midway,left] {$\sin\theta$};
...
\begin{tikzpicture}[scale=3]
    ...
    \draw[blue] (0.4,0) arc (0:\alpha:0.4) node[midway,right] {$\alpha$};

    % Ángulo beta desde alpha
    \def\beta{30}
    \coordinate (B) at ({\alpha+\beta}:1);
    \draw[green!70!black,thick] (0,0) -- (B);
    \draw[green!70!black] (0.4,0) arc (0:{\alpha+\beta}:0.4);
...
330/0.866/-0.5/{\frac{\sqrt{3}}{2}}/{-\frac{1}{2}}/below right%
    ...
    \draw[red,very thick] (Demo |- 0,0) -- (Demo) node[midway,left] {$\sin\theta$};
    \draw[green!60!black,very thick] (0,0) -- (Demo) node[midway,above,sloped] {$r=1$};

    % Anotación
    \node[align=center] at (0,-1.3) {$\sin^2\theta + \cos^2\theta = 1$};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=1]
    ...
    % Etiquetas
    \node at (axis cs:1.2, 0.9) {$P(\cos\theta, \sin\theta)$};
...
\begin{tikzpicture}[scale=1]
    ...
    \node at (axis cs:63, 0.3) {$(45°, 0)$};
    \node at (axis cs:48, -1) {$(90°, -1)$};
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=4.5]
    ...
    % Ángulo A
    \draw[red,thick] (0,0) -- ({4/5},{3/5}) node[midway,above] {$A$};
    ...
    % Ángulo A+B
    \draw[purple,thick] (0,0) -- ({56/65},{33/65}) node[midway,below right,sloped] {$A+B$};
    \filldraw[purple] ({56/65},{33/65}) circle (0.02);
    \draw[purple] (0.25,0) arc (0:59.49:0.13);

    % Etiquetas
    \node at (0.5,-0.1) {Suma de ángulos};
\end{tikzpicture}
\end{center}
\end{solucion}
...
\begin{tikzpicture}[scale=2.8]
    ...
    \node[green!60!black] at (0.35,0.12) {$\frac{\theta}{2}$};
...
\begin{tikzpicture}[scale=0.75]
    ...
    % Texto
    \node[below] at (0,-6.5) {\textit{``Las matemáticas son el lenguaje con el que Dios escribió el universo''}};
    \node[below] at (0,-7.5) {\small --- Galileo Galilei};
\end{tikzpicture}
\end{center}
