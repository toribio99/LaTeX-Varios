...
\node[above] at (0,0) {$C(0,0)$};

% Focos (±c, 0) = (±5, 0)
\node[circle, fill=blue, inner sep=2.5pt] at (5,0) {};
\node[above right] at (5,0) {$F_1(5,0)$};
\node[circle, fill=blue, inner sep=2.5pt] at (-5,0) {};
\node[above left] at (-5,0) {$F_2(-5,0)$};

% Vértices (±a, 0) = (±4, 0)
\node[circle, fill=green!60!black, inner sep=2.5pt] at (4,0) {};
\node[above left] at (4,0) {$V_1(4,0)$};
\node[circle, fill=green!60!black, inner sep=2.5pt] at (-4,0) {};
\node[above right] at (-4,0) {$V_2(-4,0)$};
...
% Distancias
\draw[{Latex}-{Latex}, green!60!black, very thick] (-4,-1) -- (4,-1) node[midway, below] {$2a=8$};
\draw[{Latex}-{Latex}, orange, thick] (-6.5,3) -- (-6.5,-3) node[midway, left] {$2b=6$};
\draw[{Latex}-{Latex}, blue, thick] (-5,-5) -- (5,-5) node[midway, below] {$2c=10$};
...
% Focos
\node[circle, fill=blue, inner sep=2.5pt] at (5,0) {};
\node[above right] at (5,-0.3) {$F_1(5,0)$};
\node[circle, fill=blue, inner sep=2.5pt] at (-5,0) {};
\node[above left] at (-5,-0.3) {$F_2(-5,0)$};

% Vértices
\node[circle, fill=green!60!black, inner sep=2.5pt] at (4,0) {};
\node[above left] at (4,0.3) {$V_1(4,0)$};
\node[circle, fill=green!60!black, inner sep=2.5pt] at (-4,0) {};
\node[above right] at (-4,0.3) {$V_2(-4,0)$};
...
\node[above left] at (7,-2) {$V_1(7,-2)$};
\node[circle, fill=green!60!black, inner sep=2.5pt] at (-1,-2) {};
\node[above right] at (-1,-2) {$V_2(-1,-2)$};
...
\node[below right] at (0.3,6) {$V_1(0,6)$};
\node[circle, fill=green!60!black, inner sep=2.5pt] at (0,-6) {};
\node[above right] at (0.3,-6) {$V_2(0,-6)$};
...
\node[above right] at (2.3,4) {$V_1(2,4)$};
\node[circle, fill=green!60!black, inner sep=2.5pt] at (2,-6) {};
\node[below right] at (2.3,-6) {$V_2(2,-6)$};
...
\node[above left] at (7,0) {$V_1(7,0)$};
\node[circle, fill=green!60!black, inner sep=2.5pt] at (-7,0) {};
\node[above right] at (-7,0) {$V_2(-7,0)$};

% Focos
\node[circle, fill=blue, inner sep=2.5pt] at (8.6,0) {};
\node[above] at (8.6,0) {$F_1$};
\node[circle, fill=blue, inner sep=2.5pt] at (-8.6,0) {};
\node[above] at (-8.6,0) {$F_2$};
...
\node[below right] at (0.3,10) {$V_1(0,10)$};
\node[circle, fill=green!60!black, inner sep=2.5pt] at (0,-10) {};
\node[above right] at (0.3,-10) {$V_2(0,-10)$};
...
\node[above left] at (2,5.3) {$V_1(2,5)$};
\node[circle, fill=green!60!black, inner sep=2.5pt] at (-10,5) {};
\node[above right] at (-10,5.3) {$V_2(-10,5)$};
...
\node[left] at (5,1.3) {$V_1(5,1)$};
\node[circle, fill=green!60!black, inner sep=2.5pt] at (-1,1) {};
\node[below right=1mm] at (-1,1.3) {$V_2(-1,1)$};
...
\node[above right=2mm] at (10,-0.5) {$F_1(10,0)$};
\node[circle, fill=blue, inner sep=2.5pt] at (-10,0) {};
\node[above left=2mm] at (-10,-0.5) {$F_2(-10,0)$};
...
\node[below=4mm] at (300,0) {$B(300,0)$};

% Centro
\node[circle, fill=black, inner sep=2.5pt] at (150,0) {};
\node[above=2mm] at (150,-10) {$C(150,0)$};
