...
\begin{tikzpicture}[scale=2]
    ...
    % Altura
    \node[centered] at ($(H)!0.5!(C)$) {$h = b\sin A$};
    ...
    \node[maincolor] at (1.75,0.4) {Área $= \frac{1}{2}ch= \frac{1}{2}c(b\sin A)$};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=1.8]
    ...
    % Ángulos conocidos
    \pic[draw, red, ultra thick, angle radius=0.4cm, angle eccentricity=2.5] {angle = B--A--C};
    \pic[draw, red, ultra thick, angle radius=0.4cm, angle eccentricity=2.5] {angle = C--B--A};
...
\begin{tikzpicture}[scale=1.8]
    ...
    \draw[thick, maincolor] (A) -- (B) -- (C) -- cycle;
    \node[above] at (1.5,1.7) {C};
    \node[right] at (3.15,0) {B};
    \node[left] at (0,0) {A};
    ...
    \pic[draw, blue, dashed, thick, angle radius=0.4cm, angle eccentricity=1.3] {angle = C--B--A};
    \pic[draw, blue, dashed, thick, angle radius=0.4cm, angle eccentricity=1.3] {angle = A--C--B};
...
\begin{tikzpicture}[scale=1.5]
    ...
    % Datos conocidos
    \draw[ultra thick, red] (A1) -- (B1) node[below] at ($(A1)!0.5!(B1)$) {\small conocido};
    \draw[ultra thick, red] (A1) -- (C1) node[left=2mm] at ($(A1)!0.5!(C1)$) {\small conocido};
...
\begin{tikzpicture}[scale=0.8]
    ...
    \node[left] at (1.5,3.5) {Torre};

    % Tablero del puente
    \draw[ultra thick] (-4,0) -- (4,0);
    \node[below] at (-1.2,0) {Tablero};
    ...
    \node[above] at (0,3.9) {$A$};
    \node[below] at (1.7,0) {$B$};
    \node[below] at (0.3,0) {$C$};

    % Fuerzas
    \draw[thick, red, -latex] (2,0) -- (2,-0.8) node[right] {Peso};
    \draw[thick, red, -latex] (0,3.5) -- (-0.5,3.8) node[above left] {Tensión};
...
\begin{tikzpicture}[scale=0.4]
    ...
    \coordinate (R) at (5,6);
    \pic[draw, red, ultra thick, angle radius=0.4cm, angle eccentricity=2.5] {angle = P--R--Q};
...
\begin{tikzpicture}[scale=0.5]
    ...
    \draw[thick] (B) -- (C) node[midway,right=2mm] {$a = 7$ cm};
    \draw[thick] (C) -- (A) node[midway,left=2mm] {$b = 9$ cm};
...
\begin{tikzpicture}[scale=0.4]
    ...
    \draw[thick,blue] (Y1) -- (Z1) node[midway,right=2mm] {$x = 12$};
    \draw[thick,blue] (Z1) -- (X1) node[midway,left=2mm] {$y = 8$};

    \node at (X1) [below left] {$X$};
    \node at (Y1) [below right] {$Y$};
    \node at (Z1) [above] {$Z_1$};

    \node[blue] at (5,-2) {Solución 1};
\end{tikzpicture}
\hspace{2cm}
\begin{tikzpicture}[scale=0.4]
    % Segunda solución
    ...
    \draw[thick,red] (X2) -- (Y2) node[midway,above] {$z_2$};
    \draw[thick,red] (Y2) -- (Z2) node[midway,right] {$x = 12$};
    \draw[thick,red] (Z2) -- (X2) node[midway,left=4mm] {$y = 8$};

    \node at (X2) [below left] {$X$};
    \node at (Y2) [below right] {$Y$};
    \node at (Z2) [below] {$Z_2$};

    \node[red] at (5,-5) {Solución 2};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=0.08]
    ...
    % Trayectoria
    \draw[thick,blue,-{Latex}] (A) -- (B) node[midway,left=2mm] {45 km};
    \draw[thick,blue,-{Latex}] (B) -- (C) node[midway,above right] {60 km};
    \draw[thick,red,dashed,-{Latex}] (C) -- (A) node[midway,below] {$d$};
    \draw[thick,gray,dashed] (5,38.97) -- (35,38.97);
    \draw[thick,gray,dashed] (22.5,20) -- (22.5,55);
    ...
    \node[green] at(27,32.5) {$70^\circ$};
    \node[green] at(18,23) {$30^\circ$};
...
\begin{tikzpicture}[scale=0.01]
    ...
    \draw[thick,blue] (B) -- (C) node[midway,right=2mm] {497.43 m};
...
\begin{tikzpicture}[scale=0.02]
    ...
    \draw[dashed,blue] (A) -- (P) node[midway,right] {164.52};
    ...
    \draw[thick,red] (P) -- (Q) node[midway,above left] {186.60 m};
...
\begin{tikzpicture}[scale=0.08]
    ...
    % Fuerzas (vectores)
    \draw[blue,-{Latex},very thick] (A) -- ++(10,0) node[above] {1000 N};
    \draw[blue,-{Latex},very thick] (B) -- ++(12,0) node[above] {1200 N};
    \draw[blue,-{Latex},very thick] (C) -- ++(8,0) node[above] {800 N};
...
\begin{tikzpicture}[scale=0.4]
    ...
    \pic[draw, blue, ultra thick, angle radius=0.4cm, angle eccentricity=2.5] {angle = A--C--B};
        

    \draw[blue] (1,0) arc (0:75:1) node[midway,right] {$75^\circ$};
    \draw[blue] (B) ++ (-1,0) arc (180:135:1) node[midway,left] {$45^\circ$};
    \draw[blue] (C) ++ (0.6,-1.4) arc (-70:-130:1) node[midway,below] {$60^\circ$};
...
\begin{tikzpicture}[scale=0.15]
    ...
    \node at (3.5,2) [green!60!black] {\tiny $90^\circ$};
    \end{scope}
...
\begin{tikzpicture}[scale=0.05]
    ...
    \draw[thick,-latex] (A) -- (B) node[midway,right] {50 km};
    \draw[thick,-latex] (B) -- (C) node[midway,above right] {70 km};
    ...
    % Ángulos
    \draw[green!70!black] (A) ++(1.5,14) arc (90:60:10) node[midway,centered] {\tiny $30^\circ$};
    \draw[green!70!black] (B) ++(-4.5,-10) arc (270:330:10) node[midway,right] {\tiny $60^\circ$};
...
\begin{tikzpicture}[scale=0.03]
    ...
    \draw[thick,blue] (B) -- (C) node[midway,above right] {70.6 m};

    % Torre vertical
    \draw[dashed,gray] (C) -- (51.8,0) node[below left] {base};
    ...
    % Altura
    \draw[<->,green!60!black] (55,0) -- (55,47.3) node[midway,centered] {$h=47.3$ m};
