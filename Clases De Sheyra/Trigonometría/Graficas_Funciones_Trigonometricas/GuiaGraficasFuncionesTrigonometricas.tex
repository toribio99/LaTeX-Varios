...
\begin{tikzpicture}[scale=3.5]
    ...
    \node[red,right,scale=0.7] at (0.43,0.2) {$\sin 30^\circ = \frac{1}{2}$};
...
\begin{tikzpicture}[scale=3.5]
    ...
    % Línea SENO (positivo)
    \draw[red,very thick,-{Latex}] ({\angulo}:1 |- 0,0) -- (P);
    \node[red,left,scale=0.7, rotate=90] at (-0.6,0.6) {$\sin 120^\circ = \frac{\sqrt{3}}{2}$};
...
\begin{tikzpicture}[scale=3.5]
    ...
    \node[accentcolor,scale=0.7] at (0.15,0.3) {$225^\circ$};

    % Línea COSENO (negativo)
    \draw[blue,very thick,{Latex}-] (0,0) -- ({\angulo}:1 |- 0,0);
    \node[blue,above,scale=0.7] at (-0.55,0) {$\cos 225^\circ = -\frac{\sqrt{2}}{2}$};

    % Línea SENO (negativo)
    \draw[red,very thick,{Latex}-] ({\angulo}:1 |- 0,0) -- (P);
    \node[red,right,scale=0.7, rotate=90] at (-0.8,-0.6) {$\sin 225^\circ = -\frac{\sqrt{2}}{2}$};
...
\begin{tikzpicture}[scale=3.5]
    ...
    \draw[blue,very thick,-{Latex}] (0,0) -- ({\angulo}:1 |- 0,0);
    \node[blue,above,scale=0.7] at (0.25,0.2) {$\cos 300^\circ = \frac{1}{2}$};

    % Línea SENO (negativo)
    \draw[red,very thick,{Latex}-] ({\angulo}:1 |- 0,0) -- (P);
    \node[red,left,scale=0.7, rotate=-90] at (0.6,-0.7) {$\sin 300^\circ = -\frac{\sqrt{3}}{2}$};
...
\begin{tikzpicture}[scale=3.5]
    ...
    \node[blue,right,scale=0.7] at (0.55,0.32) {$\sin\theta$};
...
\begin{tikzpicture}[scale=3.5]
    ...
    \draw[accentcolor,-{Latex}] (0.25,0) arc (0:\angulo:0.25);
    \node[accentcolor,scale=0.7] at (0.15,0.3) {$210^\circ$};

    \draw[blue,very thick,{Latex}-] (0,0) -- ({\angulo}:1 |- 0,0);
    \node[blue,above,scale=0.7] at (-0.47,0) {$-\frac{\sqrt{3}}{2}$};

    \draw[red,very thick,{Latex}-] ({\angulo}:1 |- 0,0) -- (P);
    \node[red,left,scale=0.7] at (-0.7,-0.25) {$-\frac{1}{2}$};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=3.5]
    ...
    \draw[accentcolor,-{Latex}] (0.25,0) arc (0:\angulo:0.25);
    \node[accentcolor,scale=0.7] at (0.25,0.25) {$270^\circ$};

    \filldraw[blue] (0,0) circle (0.02);
    \node[blue,right,scale=0.7] at (0.05,-0.1) {$\cos 270^\circ = 0$};
...
\begin{tikzpicture}[scale=3.5]
    ...
    \draw[thick,red] ({\angulo}:1 |- 0,0) -- (P) node[midway,left,scale=0.7] {$\sin\theta$};
...
\begin{tikzpicture}[scale=3.5]
    ...
    \draw[red,very thick,{Latex}-] ({\angulo}:1 |- 0,0) -- (P);
    \node[red,right,scale=0.7] at (0.55,-0.3) {$-0.8$};
\end{tikzpicture}
\end{center}
\end{solucion}
