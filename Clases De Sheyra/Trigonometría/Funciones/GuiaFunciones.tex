...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\small\textcolor{maincolor}{\thepage \quad Funciones: Concepto y Aplicaciones}}
\fancyhead[RO]{\small\textcolor{maincolor}{Funciones: Concepto y Aplicaciones \quad \thepage}}
...
\usepackage{hyperref}
\hypersetup{colorlinks=true,linkcolor=violet!75!black,urlcolor=blue}
...
\textbf{Respuesta:} $\boxed{\text{Solo (a) es función}}$
...
\begin{minipage}[t]{0.48\textwidth}
\centering
\textbf{Relación (b) - NO ES función}
\begin{tikzpicture}[scale=0.85]
    \draw[thick] (-1.5,0) ellipse (0.7cm and 2cm);
    \node at (-1.5,2.3) {\small Dominio};
    \node (x1) at (-1.5,1.2) {$1$};
