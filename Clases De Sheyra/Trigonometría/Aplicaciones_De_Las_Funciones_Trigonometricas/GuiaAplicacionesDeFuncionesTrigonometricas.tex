...
\begin{tikzpicture}[scale=1.2]
  ...
  \draw[line width=1.5pt, maincolor] (A) -- node[below] {Cateto adyacente a $\alpha$} (B)--node[right] {Cateto opuesto a $\alpha$} (C)--node[above left, sloped] {Hipotenusa} (A);
  ...
  \draw[examplecolor, line width=1pt] (4.3,2.6) arc (170:265:.75);
  \node[examplecolor] at (4.7,2.5) {$\beta$};

  % Etiquetas de medidas
  \node[below, maincolor] at (2.5,-0.5) {$b$};
  \node[right, maincolor] at (5.3,1.1) {$a$};
...
\begin{tikzpicture}[scale=1.2]
  ...
  \node[above, examplecolor] at (2.6,0.2) {Línea horizontal};

  % Línea de visión
  \draw[line width=1.5pt, accentcolor, -{Latex}] (0,0.2) -- (5.25,4);
  \node[above, accentcolor, sloped, rotate=36] at (2.6,2.2) {Línea de visión};

  % Ángulo de elevación
  \draw[accentcolor, line width=1pt] (1.2,0.2) arc (0:36:1.2);
  \node[accentcolor] at (2.7,0.8) {Ángulo de elevación};

  % Distancia horizontal
  \draw[{Latex}-{Latex}, line width=1pt, maincolor] (0,-.2) -- (5,-0.2);
  \node[below, maincolor] at (2.5,-0.2) {Distancia horizontal};

  % Altura
  \draw[{Latex}-{Latex}, line width=1pt, maincolor] (6,0) -- (6,4);
...
\begin{tikzpicture}[scale=1.2]
  ...
  \node[below, examplecolor] at (5.5,0.8) {Objeto};
  ...
  % Línea de visión
  \draw[line width=1.5pt, accentcolor, -{Latex}] (0.5,4) -- (5,0.15);
  \node[below, accentcolor, sloped, rotate=-41] at (2.8,2) {Línea de visión};

  % Ángulo de depresión
  \draw[accentcolor, line width=1pt] (1.5,4) arc (0:-40:1);
  \node[accentcolor, rotate=-41] at (2.7,2.8) {Ángulo de depresión};

  % Distancia horizontal
  \draw[{Latex}-{Latex}, line width=1pt, maincolor] (0.5,-0.2) -- (5,-0.2);
  \node[below, maincolor] at (2.75,-0.2) {Distancia horizontal};

  % Altura del edificio
  \draw[{Latex}-{Latex}, line width=1pt, maincolor] (-0.8,0) -- (-0.8,4);
...
\begin{tikzpicture}[scale=1]
  ...
  \node[accentcolor] at (1.7,2.7) {Depresión};

  % Ángulo de elevación
  \draw[examplecolor, line width=1pt] (2.2,0) arc (180:135:0.8);
  \node[examplecolor] at (1.3,0.5) {Elevación};
...
\draw[thick, -{Latex}] (-50,0) -- (-25,35);
\node at (-40,5) {35°};
\draw[{Latex}-{Latex}] (-50,-5) -- (0,-5);
\node at (-25,-8) {50 m};
\draw[{Latex}-{Latex}] (25,0) -- (25,70);
\node at (30,35) {$h = ?$};
% Persona
...
\draw[{Latex}-{Latex}] (0,-0.5) -- (10,-0.5);
\node at (5,-0.8) {$d = ?$};
\draw[{Latex}-{Latex}] (10.5,0) -- (10.5,1.22);
\node at (11,0.61) {$h = ?$};
% Textura rampa
...
\node at (5,2.5) {42°};
% Distancias
\draw[{Latex}-{Latex}] (-25,-3) -- (0,-3);
\node at (-12.5,-5) {2,500 m};
\draw[{Latex}-{Latex}] (0,-3) -- (15,-3);
\node at (7.5,-5) {$x$};
% Altura
\draw[dashed] (15,0) -- (15,40);
\draw[{Latex}-{Latex}] (18,0) -- (18,40);
\node at (21,20) {$h = ?$};
% Personas
\foreach \x in {-25, 0} {
    \draw (\x,0) circle (0.4);
...
% Medidas
\draw[{Latex}-{Latex}] (-20,0) -- (-20,85);
\node at (-30,42.5) {85 m};
\draw[{Latex}-{Latex}] (0,-15) -- (100,-15);
\node at (50,-20) {$d = ?$};
% Distancia directa
...
% Ángulos
\draw (10,0) arc (0:38:20);
\node at (25,8) {38°};
\draw (130,0) arc (180:128:20);
\node at (125,8) {52°};
% Distancia AC
\draw[{Latex}-{Latex}] (0,-10) -- (150,-10);
\node at (75,-15) {150 m};
% Ancho del río
\draw[dashed, red] (0,0) -- (0,120);
\draw[{Latex}-{Latex}] (-10,0) -- (-10,120);
\node at (-20,60) {$h = ?$};
% Vegetación
...
\node at (-35,4) {30°};
% Medidas
\draw[{Latex}-{Latex}] (-50,0) -- (0,0);
\node at (-25,-2) {50 m};
\draw[{Latex}-{Latex}] (12,1.7) -- (12,30);
\node at (16,15) {$h$};
% Persona
\draw (-50,0) -- (-50,1.7);
...
\begin{tikzpicture}[scale=0.05]
% Río
\fill[cyan!20] (0,-30) rectangle (150,80);
% Orillas
\draw[very thick, brown] (0,-30) -- (150,-30);
...
\node at (60,3) {45°};
% Medidas
\draw[{Latex}-{Latex}] (20,-15) -- (70,-15);
\node at (45,-20) {50 m};
\draw[{Latex}-{Latex}] (20,-5) -- (45,-5);
\node at (32.5,-9) {25 m};
\draw[{Latex}-{Latex}] (45,-5) -- (70,-5);
\node at (57.5,-9) {25 m};
% Ancho del río
\draw[dashed] (45,0) -- (45,80);
\draw[{Latex}-{Latex}] (50,0) -- (50,80);
\node at (55,40) {Ancho = ?};
\end{tikzpicture}
\end{center}
...
% Ejes
\draw[gray, -{Latex}] (0,-20) -- (0,120) node[above] {N};
\draw[gray, -{Latex}] (-20,0) -- (150,0) node[right] {E};
% Puerto
\fill[brown] (0,0) circle (3) node[below left] {Puerto};
% Tramo 1: N45°E, 100 km
\draw[thick, blue, -{Latex}] (0,0) -- (70.7,70.7);
\node[above left] at (35,35) {100 km};
\node at (25,10) {45°};
% Tramo 2: E60°S, 80 km
\draw[thick, red, -{Latex}] (70.7,70.7) -- (110.7,1.42);
\node[right] at (90,35) {80 km};
% Isla
\fill[green] (110.7,1.42) circle (4) node[right] {Isla};
% Regreso directo
\draw[thick, green, dashed, -{Latex}] (110.7,1.42) -- (0,0);
...
\node at (7,0.2) {4.76°};
\draw[{Latex}-{Latex}] (0,-0.5) -- (14.4,-0.5);
\node at (7.2,-0.8) {14.4 m};
\draw[{Latex}-{Latex}] (14.8,0) -- (14.8,1.2);
...
\begin{tikzpicture}[scale=0.08]
    ...
    \draw[-{Latex}] (0,0) -- (0,80) node[above] {N};
    \draw[-{Latex}] (0,0) -- (80,0) node[right] {E};
    \draw[-{Latex}] (0,0) -- (0,-20) node[below] {S};
    \draw[-{Latex}] (0,0) -- (-20,0) node[left] {O};
    ...
    % Primera etapa
    \draw[thick, blue, -{Latex}] (0,0) -- (25,43.3);
    \node[circle, fill=red, inner sep=2pt] at (25,43.3) {};
    \node[above left] at (25,43.3) {$A$};
    \node[above left ] at(12.5,21.65){50 km};

    % Segunda etapa
    \draw[thick, blue, -{Latex}] (25,43.3) -- (59.64,63.3);
    \node[circle, fill=green, inner sep=2pt] at (59.64,63.3) {};
    \node[right] at (59.64,63.3) {$B$};
    \node[above left] at (42.32,53.3) {40 km};
...
\begin{tikzpicture}[scale=0.1]
    % Montaña
    \draw[thick, fill=brown!30] plot[smooth] coordinates {(-10,0) (0,0) (10,40) (20,42) (30,45) (40,42) (50,40) (60,0) (70,0)};

    % Cima
    \node[circle, fill=red, inner sep=2pt] at (30,45) {};
    \node[above] at (30,45) {Cima};

    % Punto A
    \node[circle, fill=blue, inner sep=2pt] at (-30,0) {};
    \node[below] at (-30,0) {$A$};

    % Punto B
    \node[circle, fill=blue, inner sep=2pt] at (20,0) {};
    \node[below] at (20,0) {$B$};

    % Base de la montaña
    \node[circle, fill=green, inner sep=2pt] at (30,0) {};
    \node[below] at (30,0) {Base};

    % Líneas de visión
    \draw[dashed, red] (-30,0) -- (30,45);
    \draw[dashed, blue] (20,0) -- (30,45);

    % Distancia A-B
    \draw[{Latex}-{Latex}] (-30,-5) -- (20,-5);
    \node[below] at (-5,-5) {500 m};

    % Altura
    \draw[{Latex}-{Latex}] (35,0) -- (35,45);
    \node[right] at (35,22.5) {$h$};

    % Ángulos
    \draw[thick] (-25,0) arc (0:38:5);
    \node at (-22,3) {38°};

    \draw[thick] (24,0) arc (0:52:4);
    \node at (26.5,3.5) {52°};

    % Distancia B-Base
    \draw[{Latex}-{Latex}] (20,-10) -- (30,-10);
    \node[below] at (25,-10) {$x$};
\end{tikzpicture}
\end{center}
\end{ejercicio}
