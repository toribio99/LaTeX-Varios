...
\begin{tikzpicture}[scale=3]
    ...
    % Radio = 1
    \draw[accentcolor,thick,->] (0,0) -- (1,0) node[midway,below] {$r=1$};
...
\begin{tikzpicture}[scale=3.5]
    ...
    \foreach \ang/\etiqueta/\pos in {0/{(1,0)}/right, 30/{$(\cos 30°, \sin 30°)$}/above right,
                                      60/{$(\cos 60°, \sin 60°)$}/above right,
                                      90/{$(0,1)$}/above, 120/{$(\cos 120°, \sin 120°)$}/above left,
                                      150/{$(\cos 150°, \sin 150°)$}/above left} {
        \filldraw[accentcolor] (\ang:1) circle (0.02);
        \node[\pos] at (\ang:1.15) {\tiny \etiqueta};
    }

    % Ángulo de 30 grados destacado
    \draw[accentcolor,thick,->] (0,0) -- (30:1);
    \draw[accentcolor,->] (0.3,0) arc (0:30:0.3) node[midway,right] {\tiny $30°$};

    % Proyecciones
    \draw[dashed,gray] (30:1) -- (30:1 |- 0,0) node[below] {\tiny $\cos 30°$};
    \draw[dashed,gray] (30:1) -- (0,0 -| 30:1) node[left] {\tiny $\sin 30°$};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=2]
    ...
    % Ángulo theta
    \draw[accentcolor,->] (0.5,0) arc (0:33.69:0.5) node[midway,right] {$\theta$};
...
\begin{tikzpicture}[scale=3]
    ...
    % Radio
    \draw[accentcolor,very thick,->] (0,0) -- (P) node[midway,above,sloped] {$r=1$};
    ...
    \draw[very thick,blue,->] (0,0) -- ({\angulo}:1 |- 0,0) node[midway,below] {$\cos\theta$};
    \draw[very thick,red,->] ({\angulo}:1 |- 0,0) -- (P) node[midway,right] {$\sin\theta$};
...
\begin{tikzpicture}[scale=3]
    ...
    \draw[blue,->] (0.3,0) arc (0:\angulo:0.3) node[midway,right] {\tiny $\theta$};
    ...
    \draw[red,->] (0.3,0) arc (0:-\angulo:0.3) node[midway,right] {\tiny $-\theta$};
...
\begin{tikzpicture}[scale=2.5]
    ...
    % 60 grados
    \draw[blue,thick,->] (0,0) -- (60:1);
    \filldraw[blue] (60:1) circle (0.02) node[above right] {$60°$};
    \draw[blue,->] (0.3,0) arc (0:60:0.3) node[midway,right] {\tiny $60°$};

    % 300 grados
    \draw[red,thick,->] (0,0) -- (300:1);
    \filldraw[red] (300:1) circle (0.02) node[below right] {$300°$};
    \draw[red,->] (0.3,0) arc (0:-60:0.3) node[midway,right] {\tiny $-60°$};
...
\begin{tikzpicture}[scale=0.3]
    ...
    \draw[->,thick] (0,-2) -- (0,18) node[above] {$y$};
    ...
    % Radio
    \draw[accentcolor,very thick,->] (0,0) -- (P) node[midway,above,sloped] {$r=17$ m};

    % Ángulo
    \draw[accentcolor,->] (3,0) arc (0:118:3) node[midway,above] {$\theta$};
