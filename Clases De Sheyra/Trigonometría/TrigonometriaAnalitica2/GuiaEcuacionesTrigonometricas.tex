...
\begin{tikzpicture}[scale=1.2]
    ...
    % Etiquetas
    \node[above right,accentcolor] at (axis cs:30,0.5) {$30°$};
    \node[above right,accentcolor] at (axis cs:150,0.5) {$150°$};
    \node[above left,accentcolor] at (axis cs:390,0.5) {$390°$};
    \node[above right,accentcolor] at (axis cs:510,0.5) {$510°$};

    \node[maincolor,above] at (axis cs:360,1) {$y = \sin x$};
    \node[accentcolor] at (axis cs:650,.7) {$y = 0.5$};
...
\begin{tikzpicture}[scale=1.2]
    ...
    % Etiquetas
    \node[below left,accentcolor] at (axis cs:120,-0.5) {$120°$};
    \node[below right,accentcolor] at (axis cs:240,-0.5) {$240°$};
    \node[below left,accentcolor] at (axis cs:480,-0.5) {$480°$};
    \node[below right,accentcolor] at (axis cs:600,-0.5) {$600°$};

    \node[maincolor,above] at (axis cs:80,1) {$y = \cos x$};
    \node[accentcolor] at (axis cs:650,-0.7) {$y = -0.5$};
...
\begin{tikzpicture}[scale=1.2]
    ...
    % Etiquetas
    \node[above left,accentcolor] at (axis cs:45,1) {$45°$};
    \node[above left,accentcolor] at (axis cs:225,1) {$225°$};
    \node[above left,accentcolor] at (axis cs:405,1) {$405°$};

    \node[maincolor] at (axis cs:135,2.5) {$y = \tan x$};
    \node[accentcolor] at (axis cs:500,1.35) {$y = 1$};
...
\begin{tikzpicture}[scale=1.2]
    ...
    % Etiquetas
    \node[below right=1mm,accentcolor] at (axis cs:0,1) {$(0°, 1)$};
    \node[above left,accentcolor] at (axis cs:90,1) {$(90°, 1)$};

    \node[maincolor] at (axis cs:300,0.85) {$y = \sin x + \cos x$};
...
\begin{tikzpicture}[scale=1.2]
    ...
    \node[below right,accentcolor] at (axis cs:210,0) {$210°$};
    \node[below left,accentcolor] at (axis cs:330,0) {$330°$};
...
\begin{tikzpicture}[scale=1.2]
    ...
    \node[above right,thirdcolor] at (axis cs:90,0) {$90°$};
    \node[above,thirdcolor] at (axis cs:150,0.866) {$150°$};
    \node[above right,thirdcolor] at (axis cs:277,0) {$270°$};

    \node[maincolor] at (axis cs:170,0.65) {$y = \sin(2x)$};
    \node[accentcolor] at (axis cs:45,0.25) {$y = \cos x$};
...
\begin{tikzpicture}[scale=0.8]
    ...
    % Axes
    \draw[-{Latex},thick] (-1,0) -- (8.5,0) node[right] {$x$};
    \draw[-{Latex},thick] (0,-1) -- (0,6.5) node[above] {$y$};
    ...
    \node[red,rotate=35] at (2.5,2.25) {$\times$ Bloqueado};

    % Actual path
    \draw[thirdcolor,very thick,-{Latex},>=stealth] (0,0) -- (4,0) node[midway,below] {Tramo 1};
    \draw[thirdcolor,very thick,-{Latex},>=stealth] (4,0) -- (4,3) node[midway,right] {Tramo 2};
    \draw[thirdcolor,very thick,-{Latex},>=stealth] (4,3) -- (7,3) node[midway,below] {Tramo 3};
    \draw[thirdcolor,very thick,-{Latex},>=stealth] (4,3) -- (7,5) node[midway,above,sloped] {Tramo 4};

    % Angles
    \draw[accentcolor,-{Latex}] (1,0) arc (0:35:1) node[midway,right] {$\theta_1$};
    \draw[accentcolor,-{Latex}] (4,0.5) arc (90:35:0.5);
    \draw[accentcolor,-{Latex}] (4.5,3) arc (0:34:0.5);
...
\begin{tikzpicture}[scale=1.2]
    ...
    % Radio
    \draw[{Latex}-{Latex},thick] (0,0) -- (2,0) node[midway,above] {$r$};

    % Trayectoria del carro
    \draw[maincolor,very thick,-{Latex}] (2,0) arc (0:120:2);
    ...
    \filldraw[accentcolor] (120:2) circle (2pt) node[below right] {$t=t_2$};

    % Ángulos
    \draw[thirdcolor,-{Latex}] (0.5,0) arc (0:60:0.5) node[midway,left=1mm] {$\omega t_1$};
    \draw[thirdcolor,-{Latex}] (0.7,0) arc (0:120:0.7) node[near end,right=4mm] {$\omega t_2$};

    % Vectores de velocidad (tangentes)
    \draw[red,thick,-{Latex}] (2,0) -- (2,0.7) node[right] {$\vec{v}$};
    \draw[red,thick,-{Latex}] (60:2) -- +(-30:0.7) node[above] {$\vec{v}$};
    \draw[red,thick,-{Latex}] (120:2) -- +(-210:0.7) node[left] {$\vec{v}$};
\end{tikzpicture}
\end{center}
...
\begin{axis}[
    ...
    \node[red] at (axis cs:5.5, 1.1) {$y = \frac{\sqrt{3}}{2}$};
\end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=2.5]
    ...
    % Ejes
    \draw[-{Latex}] (-1.3,0) -- (1.3,0) node[right] {$x$};
    ...
    % Ángulos
    \draw[blue, -{Latex}] (0.3,0) arc (0:30:0.3) node[midway, right] {$30^\circ$};
    \draw[blue, -{Latex}] (0.3,0) arc (0:150:0.3) node[midway, above] {$150^\circ$};
\end{tikzpicture}
\end{center}
...
\begin{axis}[
    ...
    \node[left=1mm] at (axis cs:0.447, 0.464) {$\left(\frac{\sqrt{5}}{5}, \arcsin\left(\frac{\sqrt{5}}{5}\right)\right)$};
\end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=0.06]
    ...
    % Ejes
    \draw[-{Latex}] (-60,0) -- (110,0) node[right] {$x$};
    \draw[-{Latex}] (0,-60) -- (0,60) node[above] {$y$};
\end{tikzpicture}
\end{center}
...
\begin{axis}[
    ...
    \node[above right] at (axis cs:6.72, 0) {$t \approx 6.72h$};
    \node[below, rotate=90] at (axis cs:10.75, 7.8) {$t \approx 11.28h$};
\end{axis}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=0.9]
    ...
    % Radios
    \draw[red,thick] (0,0) -- (30:3) node[midway,above right, rotate=30] {$r=10$};
