...
\begin{tikzpicture}[
    ...
    \node[font=\small, maincolor] at (3.5, 0.4) {Urna: 3 rojas + 2 azules = 5 bolas};
...
\node[text width=4cm, draw=none, fill=none, right] at (4.5,.5) {\small\textit{El árbol completo tendría 24 ramas finales}};
\end{tikzpicture}
\end{center}
...
\node[draw=none] at (9.5, 0) {$P(RA) = \frac{5}{8} \times \frac{3}{7} = \frac{15}{56}$};
\node[draw=none] at (9.5, -2) {$P(AR) = \frac{3}{8} \times \frac{5}{7} = \frac{15}{56}$};
\node[draw=none] at (9.5, -4) {$P(AA) = \frac{3}{8} \times \frac{2}{7} = \frac{6}{56} = \frac{3}{28}$};
\end{tikzpicture}
\end{center}
...
% Probabilidades finales
\node[draw=none, font=\small] at (13, 2.5) {$P = 0.7 \times 0.7 = 0.49$};
\node[draw=none, font=\small] at (13, 0.85) {$P = 0.7 \times 0.3 = 0.21$};
\node[draw=none, font=\small] at (13, -0.85) {$P = 0.3 \times 0.3 = 0.09$};
\node[draw=none, font=\small] at (13, -2.5) {$P = 0.3 \times 0.7 = 0.21$};
\end{tikzpicture}
\end{center}
...
\node[fill=gray!20] {Población}
    child {node[fill=red!30] {Enfermo}
        child {node[fill=red!20] {Test +}
            edge from parent node[below, draw=none, font=\small] {0.95}
        }
        child {node[fill=green!20] {Test -}
            edge from parent node[above, draw=none, font=\small] {0.05}
        }
        edge from parent node[above, draw=none] {0.01}
    }
    child {node[fill=green!30] {Sano}
        child {node[fill=red!20] {Test +}
            edge from parent node[below, draw=none, font=\small] {0.10}
        }
        child {node[fill=green!20] {Test -}
            edge from parent node[above, draw=none, font=\small] {0.90}
        }
        edge from parent node[below, draw=none] {0.99}
    };

% Probabilidades conjuntas
\node[draw=none, font=\small] at (11.5, 3) {$P = 0.01 \times 0.95 = 0.0095$};
\node[draw=none, font=\small] at (11.66, 1) {$P = 0.01 \times 0.05 = 0.0005$};
\node[draw=none, font=\small] at (11.5, -1) {$P = 0.99 \times 0.10 = 0.099$};
\node[draw=none, font=\small] at (11.5, -3) {$P = 0.99 \times 0.90 = 0.891$};
\end{tikzpicture}
\end{center}
