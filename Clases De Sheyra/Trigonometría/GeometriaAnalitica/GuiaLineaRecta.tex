...
\node[orange, below right] at (axis cs:3.4,3.85) {$m = \frac{2.25}{3} = 0.75$};

% Ángulo de inclinación
\draw[thick, red] (axis cs:-1.5,0) arc (0:37:0.5);
\node[red] at (axis cs:-0.65,0.3) {$\theta \approx 37°$};
...
\addplot[mark=*, mark size=3pt, thirdcolor] coordinates {(-2,-2.8)};
...
\node[above left, blue] at (axis cs:2,3) {$A(2,3)$};
...
\node[below right, red] at (axis cs:1,6) {$M(1,6)$};
...
\node[above left, red] at (axis cs:3,5) {Almacén $P(3,5)$};
...
\node[below right, red] at (axis cs:5,12) {$B(5,12)$};

% Intersecciones con los ejes
\addplot[only marks, mark=*, mark size=4pt, color=green!70!black] coordinates {(-1,0) (0,2)};
\node[above left, green!70!black] at (axis cs:-1,0) {$(-1,0)$};
\node[below right, green!70!black] at (axis cs:0,2) {$(0,2)$};
...
\node[above left, red] at (axis cs:5,3) {$C(5,3)$};
...
\node[above right, red] at (axis cs:10,20) {$A(10,20)$ $t=0$ min};
\node[above left, red] at (axis cs:40,50) {$B(40,50)$ $t=30$ min};
\node[above left, red] at (axis cs:70,80) {$(70,80)$ $t=60$ min};
...
\node[below right, green!70!black] at (axis cs:25,35) {$30\sqrt{2}$ km};
\node[below right, orange] at (axis cs:55,65) {$30\sqrt{2}$ km};
...
\node[above left] at (axis cs:6.44,11.16) {$I(6.44, 11.16)$};
\node[above left] at (axis cs:12.89,0) {$(12.89, 0)$};
...
\node[right, red] at (axis cs:2,3) {$A(2,3)$};
\node[above left, red] at (axis cs:8,7) {$B(8,7)$};
\node[above left, red] at (axis cs:14,11) {$C(14,11)$};
\node[above left, red] at (axis cs:22.32,16.55) {$D(22.32,16.55)$};
...
\node[below left, blue] at (axis cs:6,2) {$P(6,2)$};
...
\node[right=2mm] at (axis cs:4,2) {$I_a(4,2)$};
...
\node[left=2mm] at (axis cs:3,3) {$I_c(3,3)$};
...
\node[right=3mm, orange] at (axis cs:6.86,5.43) {Rotonda $I(6.86, 5.43)$};
