...
\begin{tikzpicture}[scale=1.2]
    ...
    \draw[accentcolor, line width=1pt] ($(B)!0.5!(C)$) ++(-0.1,0.1) -- ++(-0.2,0.2);
    \draw[accentcolor, line width=1pt] ($(A)!0.5!(C)$) ++(0.1,0.1) -- ++(0.2,0.2);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=1.2]
    ...
    \draw[accentcolor, line width=1pt] ($(A)!0.5!(C)$) ++(0.15,0.1) -- ++(0.3,0.2);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=1.5]
    ...
    \draw[->, accentcolor, line width=1pt] (2.5,-0.5) -- (2.5,-0.1);
    ...
    \draw[->, accentcolor, line width=1pt] (-1,1.5) -- (-0.1,1.5);
...
\begin{tikzpicture}[scale=1.3]
    ...
    \node[right, font=\Large, text=accentcolor] at (2.1,1.5) {$h$ (altura)};
