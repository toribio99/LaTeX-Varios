...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\small\textcolor{maincolor}{\thepage \quad Funciones Trigonométricas Segunda Parte}}
\fancyhead[RO]{\small\textcolor{maincolor}{Funciones Trigonométricas Segunda Parte \quad \thepage}}
...
\begin{tikzpicture}[scale=2]
    ...
    \node[right] at (4,1.3) {\large Cateto opuesto};
...
\begin{tikzpicture}[scale=1.5]
    ...
    % Cuadrantes
    \node[maincolor] at (axis cs:0.5,0.5) {\Large I};
    \node[maincolor] at (axis cs:-0.5,0.5) {\Large II};
    \node[maincolor] at (axis cs:-0.5,-0.5) {\Large III};
    \node[maincolor] at (axis cs:0.5,-0.5) {\Large IV};
...
\begin{tikzpicture}[scale=1.1]
    ...
    \node[red,above right] at (axis cs:0.5,0.8) {$(0.643, 0.766)$};

    % Etiquetas de ángulos
    \node[red] at (axis cs:0.19,0.07) {$50°$};
    \node[blue] at (axis cs:0.62,0.2) {$410°$};
    \node[green!70!black] at (axis cs:0.65,0.5) {$-310°$};
    
    % Arcos
    \draw[red,thick,-{Latex}] (0.3,0) arc (0:50:0.3);
    %\node[blue] at (0.35,0.12) {\small $45°$};
    
    \draw[blue,thick,-{Latex}] (0.5,0) arc (0:410:0.5);
    %\node[red] at (1.20,0.4) {\small $405°$};
    
    \draw[green!70!black,thick,-{Latex}] (0.8,0) arc (0:-310:0.8);
...
\begin{tikzpicture}[scale=0.08]
    ...
    % Etiquetas
    \node[below] at (25,-2) {50 m};
    \node[right] at (63,43) {$h = ?$};
...
\begin{tikzpicture}[scale=0.08]
    ...
    % Ángulo de depresión
    \draw[thick,orange] (23,80) arc (0:-0:15);
    \draw[thick,orange] (5,80)--(25,80);
    \draw[thick,orange] (5,80)--(5,60);
    \draw[thick,orange] (8,77) arc (280:360:3);
    \node[orange] at (16,77) {$30°$};
...
\begin{tikzpicture}[scale=0.5]
    ...
    \node[blue,above left] at (4.7,4.5) {10 m};
...
\begin{tikzpicture}[scale=1.1]
    ...
    % Cuadrante III
    \node[maincolor] at (axis cs:-0.6,-0.5) {\Large III};
    ...
    \node[blue] at (axis cs:-0.49,-0.2) {$63.43°$};
...
\begin{center}
	\begin{tikzpicture}[scale=1.5]
		...
		% Ejes
		\draw[-{Latex},thick] (-2.3,0)--(2.3,0) node[right] {$x$};
		\draw[-{Latex},thick] (0,-2.3)--(0,2.3) node[above] {$y$};
		
		% Ángulos especiales con etiquetas
		\foreach \angle/\label in {
			30/30°, 45/45°, 60/60°, 90/90°, 120/120°, 135/135°, 150/150°, 
			180/180°, 210/210°, 225/225°, 240/240°, 270/270°, 300/300°, 315/315°, 330/330°} {
			% Radio y punto
			\draw[red!70!black] (0,0)--(\angle:2);
			\fill[blue] (\angle:2) circle (0.05);
			
			% Etiqueta
			\node[font=\small, black] at (\angle:2.3) {\label};
		}
...
\begin{center}
	\begin{tikzpicture}[scale=1.5]
		...
		\foreach \angle/\label in {
			...
			% Etiqueta
			\node[font=\small, rotate=\angle, anchor=south] at (\angle:2.3) {\label};
