...
\begin{axis}[
    ...
    restrict y to domain=-10:10,
    legend style={
	at={(0.85,0.8)}, % Coordenadas relativas dentro del área del gráfico
	anchor=south east,% Qué parte de la leyenda se alinea con esas coordenadas
	font=\small,
	fill=white,
	draw=black
	},
...
\begin{axis}[
    ...
    major grid style={line width=.2pt,draw=gray!50},
    legend style={
    	at={(0.5,0.8)},  % centrado horizontalmente arriba
...
\begin{axis}[
    ...
    \node[gray, right] at (axis cs:4, 2.3) {Eje central: $y=2$};
\end{axis}
\end{tikzpicture}
\end{center}
\end{solucion}
...
\begin{axis}[
    ...
    \node[maincolor] at (axis cs:0.7854, 1.2) {Intersección};
    \node[maincolor] at (axis cs:3.927, -1.2) {Intersección};
\end{axis}
\end{tikzpicture}
\end{center}
...
\begin{axis}[
    ...
    \node[gray, right] at (axis cs:15, 3.2) {Nivel promedio};
\end{axis}
\end{tikzpicture}
\end{center}
