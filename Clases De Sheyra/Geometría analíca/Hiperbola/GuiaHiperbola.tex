...
\begin{document}
	...
	\begin{tikzpicture}[scale=0.6]
		...
		\node[black,below=2pt,scale=0.75] at (3,0.9) {$C$};

		% Focos (c=3, a=2, b=√5≈2.24, c²=a²+b²=4+5=9, c=3)
		\filldraw[blue] (0,0) circle (2pt);
		\filldraw[blue] (6,0) circle (2pt);
		\node[blue,scale=0.65] at (-0.4,0.4) {$F_1$};
		\node[blue,scale=0.65] at (6,0.4) {$F_2$};

		% Vértices
		\filldraw[purple] (1,0) circle (2pt);
		\filldraw[purple] (5,0) circle (2pt);
		\node[purple,scale=0.65] at (1.3,0.3) {$V_1$};
		\node[purple,scale=0.65] at (4.7,0.3) {$V_2$};

		% Asíntotas
		\draw[dashed,orange,thick] (0,-3.35)--(6,3.35);
		\draw[dashed,orange,thick] (0,3.35)--(6,-3.35);
		\node[orange,scale=0.6] at (4,2.7) {Asíntotas};
		\node[orange,scale=0.6] at (1.7,2.7) {Asíntotas};
	...
	\begin{center}
		\begin{tikzpicture}
			...
			% Asíntotas
			\addplot[orange, dashed, thick, domain=-8:8] {0.75*x} node at(5,5)  {$y=\frac{3}{4}x$};
			\addplot[orange, dashed, thick, domain=-8:8] {-0.75*x} node at(5,-5)  {$y=-\frac{3}{4}x$};
			...
			% Focos
			\node[circle, fill=blue, inner sep=2pt, label={above left=3mm:$F_1(-5,0)$}] at (-5,0) {};
			\node[circle, fill=blue, inner sep=2pt, label={above right=3mm:$F_2(5,0)$}] at (5,0) {};

			% Vértices
			\node[circle, fill=purple, inner sep=1.5pt, label={above right=3mm:$V_1(-4,0)$}] at (-4,0) {};
			\node[circle, fill=purple, inner sep=1.5pt, label={above left=3mm:$V_2(4,0)$}] at (4,0) {};

			% Etiqueta de la ecuación
			\node[red] at (-3,5) {$\displaystyle\frac{x^2}{16}-\frac{y^2}{9}=1$};
	...
	\begin{center}
		\begin{tikzpicture}
			...
			% Asíntotas
			\addplot[orange, dashed, thick, domain=-7:7] {1.25*x} node[rotate=45]  at(4,6) {$y=\frac{5}{4}x$};
			\addplot[orange, dashed, thick, domain=-7:7] {-1.25*x} node[rotate=-45]  at(5,-5) {$y=-\frac{5}{4}x$};

			% Centro
			\node[circle, fill=black, inner sep=2pt, label={above right:$C(0,0)$}] at (0,0) {};

			% Focos
			\node[circle, fill=blue, inner sep=2pt, label={below right=3mm:$F_1(0,-\sqrt{41})$}] at (0,-6.4) {};
			\node[circle, fill=blue, inner sep=2pt, label={above right=1mm:$F_2(0,\sqrt{41})$}] at (0,6.4) {};

			% Vértices
			\node[circle, fill=purple, inner sep=1.5pt, label={above right=1mm:$V_1(0,-5)$}] at (0,-5) {};
			\node[circle, fill=purple, inner sep=1.5pt, label={below right=3mm:$V_2(0,5)$}] at (0,5) {};

			% Etiqueta de la ecuación
			\node[red] at (-4.2,2) {$\displaystyle\frac{y^2}{25}-\frac{x^2}{16}=1$};
	...
	\begin{center}
		\begin{tikzpicture}
			...
			% Focos
			\node[circle, fill=blue, inner sep=2pt, label={below:$F_1(-2,-2)$}] at (-2,-2) {};
			\node[circle, fill=blue, inner sep=2pt, label={below:$F_2(8,-2)$}] at (8,-2) {};

			% Vértices
			\node[circle, fill=purple, inner sep=1.5pt, label={right:$V_1(0,-2)$}] at (0,-2) {};
			\node[circle, fill=purple, inner sep=1.5pt, label={left:$V_2(6,-2)$}] at (6,-2) {};

			% Etiqueta de la ecuación
			\node[red] at (3.6,3.7) {$\displaystyle\frac{(x-3)^2}{9}-\frac{(y+2)^2}{16}=1$};
			
			% Asíntotas
			\addplot[violet, dashed, thick, domain=-3:9, dashed] {(4/3)*x-6} node[rotate=48]  at(4.9,1.5) {$y=\frac{4}{3}x-6$};
			\addplot[violet, dashed, thick, domain=-3:9, dashed] {(-4/3)*x+2} node[rotate=-53]  at(5,-5.5) {$y=-\frac{4}{3}x+2$};
	...
	\begin{center}
		\begin{tikzpicture}
			...
			% Asíntotas: y = ±(3/5)x
			\addplot[orange, dashed, thick, domain=-9:9] {0.6*x} node[rotate=25,pos=0.75, above right] {$y=\frac{3}{5}x$};
			\addplot[orange, dashed, thick, domain=-9:9] {-0.6*x} node[rotate=-25,pos=0.75, below right] {$y=-\frac{3}{5}x$};

			% Centro
			\node[circle, fill=black, inner sep=2.5pt, label={below right:$C(0,0)$}] at (0,0) {};

			% Focos: c=√34≈5.83
			\node[circle, fill=blue, inner sep=2pt, label={above left:$F_1(-\sqrt{34},0)$}] at (-5.83,0) {};
			\node[circle, fill=blue, inner sep=2pt, label={above right:$F_2(\sqrt{34},0)$}] at (5.83,0) {};

			% Vértices
			\node[circle, fill=purple, inner sep=1.5pt, label={above right:$V_1(-5,0)$}] at (-5,0) {};
			\node[circle, fill=purple, inner sep=1.5pt, label={above left:$V_2(5,0)$}] at (5,0) {};

			% Etiqueta de la ecuación
			\node[red] at (-3,5) {$\displaystyle\frac{x^2}{25}-\frac{y^2}{9}=1$};
	...
	\begin{center}
		\begin{tikzpicture}
			...
			% Asíntotas: y = ±(3/4)x
			\addplot[violet, dashed, thick, domain=-10:10] {0.75*x} node[pos=0.8, above right, rotate=43] {$y=\frac{3}{4}x$};
			\addplot[violet, dashed, thick, domain=-10:10] {-0.75*x} node[pos=0.8, below right, rotate=-43] {$y=-\frac{3}{4}x$};

			% Centro
			\node[circle, fill=black, inner sep=2.5pt, label={above right:$C(0,0)$}] at (0,0) {};
			...
			% Vértices
			\node[circle, fill=purple, inner sep=1.5pt, label={above right:$V_1(0,-6)$}] at (0,-6) {};
			\node[circle, fill=purple, inner sep=1.5pt, label={below right:$V_2(0,6)$}] at (0,6) {};
	...
	\begin{center}
		\begin{tikzpicture}[scale=.8]
			...
			\addplot[orange, dashed, thick, domain=-5:9] {(3/4)*(x-2)-1} node[pos=0.9, above, rotate=26] {$y=\frac{3}{4}x-\frac{5}{2}$};
			\addplot[orange, dashed, thick, domain=-5:9] {-(3/4)*(x-2)-1} node[pos=0.9, below, rotate=-26] {$y=-\frac{3}{4}x+\frac{1}{2}$};

			% Centro
			\node[circle, fill=black, inner sep=2pt, label={below right:$C(2,-1)$}] at (2,-1) {};

			% Focos
			\node[circle, fill=blue, inner sep=2pt, label={below left:$F_1(-3,-1)$}] at (-3,-1) {};
			\node[circle, fill=blue, inner sep=2pt, label={below right:$F_2(7,-1)$}] at (7,-1) {};

			% Vértices
			\node[circle, fill=purple, inner sep=1.5pt, label={below right:$V_1(-2,-1)$}] at (-2,-1) {};
			\node[circle, fill=purple, inner sep=1.5pt, label={below left:$V_2(6,-1)$}] at (6,-1) {};

			% Etiqueta de la ecuación
			\node[red] at (3.7,3.5) {$\displaystyle\frac{(x-2)^2}{16}-\frac{(y+1)^2}{9}=1$};
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\addplot[orange, dashed, thick, domain=-2:6] {(3/2)*(x-2)+1} node[pos=0.85, below, rotate=53] {$y=\frac{3}{2}x-2$};
			\addplot[orange, dashed, thick, domain=-2:6] {-(3/2)*(x-2)+1}node[pos=0.85, above, rotate=-49] {$y=-\frac{3}{2}x-4$};

			% Centro
			\node[circle, fill=black, inner sep=2pt, label={right:$C(2,1)$}] at (2,1) {};

			% Focos: c=√13≈3.61
			\node[circle, fill=blue, inner sep=2pt, label={below:$F_1(2,-2.61)$}] at (2,-2.61) {};
			\node[circle, fill=blue, inner sep=2pt, label={above:$F_2(2,4.61)$}] at (2,4.61) {};

			% Vértices
			\node[circle, fill=purple, inner sep=1.5pt, label={above:$V_1(2,-2)$}] at (2,-2) {};
			\node[circle, fill=purple, inner sep=1.5pt, label={below:$V_2(2,4)$}] at (2,4) {};

			% Etiqueta de la ecuación
			\node[red] at (2.2,6) {$\displaystyle\frac{(y-1)^2}{9}-\frac{(x-2)^2}{4}=1$};
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\addplot[orange, dashed, thick, domain=-7:5] {1.25*(x+1)+2} node[pos=0.85, below, rotate=40] {$y=\frac{5}{4}x+\frac{13}{4}$};
			\addplot[orange, dashed, thick, domain=-7:5] {-1.25*(x+1)+2}node[pos=0.85, above, rotate=-40] {$y=-\frac{5}{4}x+\frac{3}{4}$};

			% Centro
			\node[circle, fill=black, inner sep=2pt, label={above:$C(-1,2)$}] at (-1,2) {};

			% Focos
			\node[circle, fill=blue, inner sep=2pt, label={left=3mm:$F_1(-1,-4.40)$}] at (-1,-4.4) {};
			\node[circle, fill=blue, inner sep=2pt, label={left=3mm:$F_2(-1,8.40)$}] at (-1,8.4) {};

			% Vértices
			\node[circle, fill=purple, inner sep=2pt, label={above left:$V_1(-1,-3)$}] at (-1,-3) {};
			\node[circle, fill=purple, inner sep=2pt, label={below left:$V_2(-1,7)$}] at (-1,7) {};

			% Ecuación
			\node[red] at (-4.6,2) {$\displaystyle\frac{(y-2)^2}{25}-\frac{(x+1)^2}{16}=1$};
	...
	\begin{center}
		\begin{tikzpicture}
			...
			% Asíntotas: y = ±(4/3)x
			\addplot[orange, dashed, thick, domain=-7:7] {(4/3)*x} node[pos=0.65, rotate=53, below right] {$y=\frac{4}{3}x$};
			\addplot[orange, dashed, thick, domain=-7:7] {-(4/3)*x} node[pos=0.65, rotate=-50, below right] {$y=-\frac{4}{3}x$};
			...
			% Vértices
			\node[circle, fill=purple, inner sep=2pt, label={above right:$V_1(-3,0)$}] at (-3,0) {};
			\node[circle, fill=purple, inner sep=2pt, label={above left:$V_2(3,0)$}] at (3,0) {};

			% Ecuación
			\node[red] at (2.25,5.5) {$\displaystyle\frac{x^2}{9}-\frac{y^2}{16}=1$};
	...
	\boxed{V_1(-1,-1)\text{ y }V_2(5,-1)} \\[3mm]
	...
	Por lo tanto: $\boxed{a^2=\frac{15}{4}\text{ y }b^2=15}$ \\[3mm]
