...
\begin{document}
	...
	\begin{tikzpicture}[scale=0.75]
		...
		\node[black,below right=1pt] at (3,2.5) {$C(3,2.5)$};
		...
		% Diámetro
		\draw[orange,very thick] (1,2.5)--(5,2.5);
		\filldraw[orange] (1,2.5) circle (2pt);
		\node[orange,below=2pt,scale=0.9] at (3,2.35) {$d=4$};

		% Cuerda
		\draw[green!60!black,thick] (3+1.732,3.5)--(3-1.414,2.5-1.414);
		\node[green!60!black,scale=0.8] at (2.5,3.8) {Cuerda};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			% centro
			\filldraw[black] (0,0) circle (3pt) node[below right=3pt] {$C(0,0)$};

			% radio
			\draw[blue,very thick] (0,0)--(5,0);
			...
			\filldraw[red] (0,-5) circle (2pt);
			\node[red,scale=0.8] at (5.5,0.5) {$(5,0)$};
			\node[red,scale=0.8] at (-5.5,0.5) {$(-5,0)$};
			\node[red,scale=0.8] at (0.7,5.3) {$(0,5)$};
			\node[red,scale=0.8] at (0.7,-5.3) {$(0,-5)$};

			% etiqueta
			\node[red,scale=1.1] at (4,3.5) {$x^2+y^2=25$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			% centro
			\filldraw[black] (2,-3) circle (3pt) node[right=4pt] {$C(2,-3)$};
			...
			\node[red,scale=0.8] at (6.7,-2.5) {$(6,-3)$};
			\node[red,scale=0.8] at (-2.7,-2.5) {$(-2,-3)$};
			\node[red,scale=0.8] at (2.7,1.3) {$(2,1)$};
			\node[red,scale=0.8] at (2.7,-7.3) {$(2,-7)$};

			% etiqueta
			\node[red,scale=1] at (5,0.5) {$(x-2)^2+(y+3)^2=16$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			% centro
			\filldraw[black] (3,-2) circle (3pt) node[below right=2pt] {$C(3,-2)$};
			...
			% etiqueta
			\node[red,scale=0.9] at (6,2) {$x^2+y^2-6x+4y-12=0$};
			\node[red,scale=0.9] at (6,1.3) {o $(x-3)^2+(y+2)^2=25$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.5]
			...
			\node[red,scale=1.1] at (5,5) {$x^2+y^2=49$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.5]
			...
			\filldraw[black] (4,1) circle (3.5pt) node[below right=2pt,scale=1] {$C(4,1)$};

			\draw[blue,very thick] (4,1)--(10,1);
			\filldraw[blue] (10,1) circle (3pt);
			\node[blue,above=3pt,scale=1] at (7,1) {$r=6$};

			\node[red,scale=1] at (7,6) {$(x-4)^2+(y-1)^2=36$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.5]
			...
			\filldraw[black] (-2,5) circle (3.5pt) node[below right=2pt,scale=1] {$C(-2,5)$};

			\draw[blue,very thick] (-2,5)--(4,5);
			\filldraw[blue] (4,5) circle (3pt);
			\node[blue,above=3pt,scale=1] at (1,5) {$r=6$};

			\node[red,scale=1] at (1,10) {$(x+2)^2+(y-5)^2=36$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.55]
			...
			\node[red,scale=0.9] at (-2,9.5) {$x^2+y^2+8x-10y+16=0$};
			\node[red,scale=0.9] at (-2,8.7) {o $(x+4)^2+(y-5)^2=25$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			\node[red,scale=1] at (0,6.5) {$(x+3)^2+(y-2)^2=25$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.45]
			...
			\filldraw[purple] (6,-2) circle (3.5pt) node[right=3pt,scale=1] {$(6,-2)$};

			\node[red,scale=1.1] at (5,6) {$x^2+y^2=64$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			\node[red,scale=1] at (7,1) {$(x-5)^2+(y+3)^2=16$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			\node[red,scale=1] at (2,7) {$(x+1)^2+(y-2)^2=25$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.7]
			...
			\node[orange,below=2pt,scale=0.9] at (1,2.3) {diámetro};

			\node[red,scale=1] at (4,0) {$(x-1)^2+(y-3)^2=13$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=1.2]
			...
			\node[blue,right=3pt,scale=0.9] at (2,-0.5) {$r=1$};

			\node[red,scale=0.9] at (3.2,-2.5) {$(x-2)^2+(y+1)^2=1$};
			\node[green!60!black,scale=0.9] at (3,-3) {Tangente al eje $x$};
