...
\section{Comprobar que el triángulo es rectángulo}
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.65]
			...
			\node at ($(B)!0.55!(C)$) [below
		,scale=0.9] {$BC=\sqrt{82}$};
		\end{tikzpicture}
	\end{center}
		...
		En la gráfica se observa que \textbf{ambos quedan centrados sobre las diagonales} correspondientes.
			...
			\bigskip
			\noindent
			\textbf{Nota final:} Este taller cubre los conceptos fundamentales de geometría analítica: distancia entre puntos, teorema de Pitágoras, punto medio, triángulos isósceles y distancia de un punto a una recta. ¡Excelente trabajo, Sheyra!

			% Documento editado el 17 de octubre 2025 - Agregada nota final
