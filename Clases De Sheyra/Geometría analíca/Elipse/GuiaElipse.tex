...
\begin{document}
	...
	\begin{tikzpicture}[scale=0.75]
		...
		\node[black,below=2pt,scale=0.85] at (2.2,2.2) {$C(3,2)$};

		% Focos (c² = a² - b² = 6.25 - 2.25 = 4, c=2)
		\filldraw[blue] (5,2) circle (2pt);
		\filldraw[blue] (1,2) circle (2pt);
		\node[blue,above=1pt,scale=0.75] at (5,2) {$F_2$};
		\node[blue,above=1pt,scale=0.75] at (1,2) {$F_1$};

		% Vértices del eje mayor
		\filldraw[purple] (5.5,2) circle (2pt);
		\filldraw[purple] (0.5,2) circle (2pt);
		\node[purple,below=1pt,scale=0.7] at (5.8,2.5) {$V_2$};
		\node[purple,below=1pt,scale=0.7] at (0.25,2.5) {$V_1$};

		% Vértices del eje menor
		\filldraw[purple] (3,3.5) circle (2pt);
		\filldraw[purple] (3,0.5) circle (2pt);
		\node[purple,right=1pt,scale=0.7] at (3,3.7) {$V_3$};
		\node[purple,right=1pt,scale=0.7] at (3.1,0.2) {$V_4$};

		% Eje mayor
		\draw[orange!60!black,very thick,dashed] (0.5,2)--(5.5,2);
		\node[orange!60!black,scale=0.8] at (1.2,4) {Eje mayor};
		\draw[orange!60!black, thick,dashed, -{Latex}] (1,3.8)--(2.5,2);

		% Eje menor
		\draw[green!60!black,very thick,dashed] (3,0.5)--(3,3.5);
		\node[green!60!black,scale=0.8] at (1.2,0.3) {Eje menor};
		\draw[green!60!black, thick,dashed, -{Latex}] (1,0.5)--(3,1);

		% Semieje a
		\draw[orange,thick,{Latex}-{Latex}] (3,1.3)--(5.5,1.3);
		\node[orange,scale=0.7] at (4.25,1.1) {$a$};

		% Semieje b
		\draw[green!60!black,thick,{Latex}-{Latex}] (3.7,2)--(3.7,3.5);
		\node[green!60!black,scale=0.7] at (4,2.75) {$b$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.7]
			...
			% centro
			\filldraw[black] (0,0) circle (3pt) node[scale=0.9]  at(1,0.4){$C(0,0)$};

			% focos
			\filldraw[blue] (-4,0) circle (3pt);
			\filldraw[blue] (4,0) circle (3pt);
			\node[blue,above=3pt,scale=0.9] at (-3.5,0) {$F_1(-4,0)$};
			\node[blue,above=3pt,scale=0.9] at (3.8,0) {$F_2(4,0)$};

			% vértices del eje mayor
			\filldraw[purple] (-5,0) circle (2.5pt);
			\filldraw[purple] (5,0) circle (2.5pt);
			\node[purple,scale=0.85] at (-6.2,0.3) {$V_1(-5,0)$};
			\node[purple,scale=0.85, rotate=90] at (5.3,0.85) {$V_2(5,0)$};

			% vértices del eje menor
			\filldraw[purple] (0,-3) circle (2.5pt);
			\filldraw[purple] (0,3) circle (2.5pt);
			\node[purple,right=2pt,scale=0.85] at (0,-3.5) {$V_3(0,-3)$};
			\node[purple,right=2pt,scale=0.85] at (0,3.5) {$V_4(0,3)$};

			% eje mayor
			\draw[orange,very thick,{Latex}-{Latex}] (-5,-1.3)--(5,-1.3);
			\node[orange,scale=0.9] at (0,-1.65) {Eje mayor $=2a=10$};

			% eje menor
			\draw[green!60!black,very thick,{Latex}-{Latex}] (5.8,3)--(5.8,-3);
			\node[green!60!black,scale=0.9,rotate=90] at (6.4,0) {Eje menor $=2b=6$};

			% etiqueta
			\node[red,scale=1.1] at (-3,3.5) {$\displaystyle\frac{x^2}{25}+\frac{y^2}{9}=1$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.7]
			...
			\filldraw[blue] (0,3) circle (3pt);
			\node[blue,right=3pt,scale=0.9] at (-2.65,-3) {$F_1(0,-3)$};
			\node[blue,right=3pt,scale=0.9] at (-2.2,3) {$F_2(0,3)$};

			\filldraw[purple] (0,-5) circle (2.5pt);
			\filldraw[purple] (0,5) circle (2.5pt);
			\node[purple,right=2pt,scale=0.85] at (0,-5.5) {$V_1(0,-5)$};
			\node[purple,right=2pt,scale=0.85] at (0,5.5) {$V_2(0,5)$};

			\filldraw[purple] (-4,0) circle (2.5pt);
			\filldraw[purple] (4,0) circle (2.5pt);
			\node[purple,below=2pt,scale=0.85] at (-5.2,1) {$V_3(-4,0)$};
			\node[purple,below=2pt,scale=0.85] at (5.,1) {$V_4(4,0)$};

			\node[red,scale=1.1] at (-3,5.5) {$\displaystyle\frac{x^2}{16}+\frac{y^2}{25}=1$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			\filldraw[black] (2,-1) circle (3pt) node[scale=0.9] at(2.8,-1.5){$C(2,-1)$};

			\filldraw[blue] (-2.47,-1) circle (3pt);
			\filldraw[blue] (6.47,-1) circle (3pt);
			\node[blue,scale=0.85] at (-2.47,-1.5) {$F_1$};
			\node[blue,scale=0.85] at (6.47,-1.5) {$F_2$};

			\filldraw[purple] (-4,-1) circle (2.5pt);
			\filldraw[purple] (8,-1) circle (2.5pt);
			\node[purple,scale=0.8] at (-5.45,-1) {$V_1(-4,-1)$};
			\node[purple,scale=0.8] at (9.35,-1) {$V_2(8,-1)$};

			\filldraw[purple] (2,-5) circle (2.5pt);
			\filldraw[purple] (2,3) circle (2.5pt);
			\node[purple,right=2pt,scale=0.8] at (2,-5.4) {$V_3(2,-5)$};
			\node[purple,right=2pt,scale=0.8] at (2,3.4) {$V_4(2,3)$};

			\node[red,scale=1] at (-3.7,3.5) {$\displaystyle\frac{(x-2)^2}{36}+\frac{(y+1)^2}{16}=1$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			\filldraw[black] (0,0) circle (3.5pt) node[scale=1] at(-1.2,0.4) {$C(0,0)$};
			...
			\node[red,scale=1.1] at (-3.5,6) {$\displaystyle\frac{x^2}{49}+\frac{y^2}{25}=1$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			\filldraw[black] (0,0) circle (3.5pt) node[below ,scale=1] at(-1.2,1){$C(0,0)$};

			\filldraw[blue] (0,-5.2) circle (3pt);
			\filldraw[blue] (0,5.2) circle (3pt);
			\node[blue,right=3pt,scale=0.9] at (-1.3,-5.2) {$F_1$};
			\node[blue,right=3pt,scale=0.9] at (-1.3,5.2) {$F_2$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			\filldraw[black] (3,-2) circle (3pt) node[scale=0.9] at(3.8,-2.5){$C(3,-2)$};

			\filldraw[blue] (-1,-2) circle (3pt);
			\filldraw[blue] (7,-2) circle (3pt);
			\node[blue,above=2pt,scale=0.85] at (-1,-2) {$F_1$};
			\node[blue,above=2pt,scale=0.85] at (7,-2) {$F_2$};
			...
			\node[red,scale=1] at (5.5,2.2) {$\displaystyle\frac{(x-3)^2}{25}+\frac{(y+2)^2}{9}=1$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.8]
			...
			\draw[thick,red!65!black, {Latex}-{Latex}] (-1.5,-2) -- (-1.5,1) node at(-2.2,-1) {$a=3$};
			\draw[thick,red!65!black, dashed] (-1.5,1) -- (1,1);
			\draw[thick,red!65!black, dashed] (-1.5,-2) -- (1,-2);
			
			\draw[thick,blue!65!black, {Latex}-{Latex}] (1,-6) -- (3,-6) node 	at(2,-5.5) {$b=2$};
			\draw[thick,blue!65!black, dashed] (1,-6) -- (1,-2);
			\draw[thick,blue!65!black, dashed] (3,-6) -- (3,-2);

			\node[red,scale=0.9] at (2.8,2.35) {$\displaystyle\frac{(x-1)^2}{4}+\frac{(y+2)^2}{9}=1$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.65]
			...
			\filldraw[black] (-1,3) circle (3pt) node[scale=0.9] at(-2.3,3){$C(-1,3)$};

			\filldraw[blue] (-1,0) circle (3pt);
			\filldraw[blue] (-1,6) circle (3pt);
			\node[blue,right=2pt,scale=0.85] at (-3.5,0.5) {$F_1(-1,0)$};
			\node[blue,right=2pt,scale=0.85] at (-3.7,6) {$F_2(-1,6)$};
			...
			\node[red,scale=1] at (-3.55,9.5) {$\displaystyle\frac{(x+1)^2}{16}+\frac{(y-3)^2}{25}=1$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			\node[red,scale=1.1] at (-2.5,5) {$\displaystyle\frac{x^2}{36}+\frac{y^2}{16}=1$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.5]
			...
			\filldraw[black] (0,0) circle (3.5pt) node[scale=1] at(-1.3,0.5) {$C(0,0)$};

			\filldraw[blue] (0,-5) circle (3pt);
			\filldraw[blue] (0,5) circle (3pt);
			\node[blue,right=3pt,scale=0.9] at (-3.8,-5) {$F_1(0,-5)$};
			\node[blue,right=3pt,scale=0.9] at (-3.1,5) {$F_2(0,5)$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.6]
			...
			\node[red,scale=1] at (5,1) {$\displaystyle\frac{(x-2)^2}{25}+\frac{(y+3)^2}{9}=1$};
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.7]
			...
			\filldraw[black] (-1,2) circle (3pt) node[scale=0.9] at(-2.5,2){$C(-1,2)$};

			\filldraw[blue] (-1,5) circle (3pt);
			\filldraw[blue] (-1,-1) circle (3pt);
			\node[blue,right=2pt,scale=0.85] at (-3.5,5) {$F_2(-1,5)$};
			\node[blue,right=2pt,scale=0.85] at (-3.9,-1) {$F_1(-1,-1)$};

			\filldraw[purple] (-1,7) circle (2.5pt);
			\filldraw[purple] (-1,-3) circle (2.5pt);

			\node[red,scale=1] at (-4,7.85) {$\displaystyle\frac{(x+1)^2}{16}+\frac{(y-2)^2}{25}=1$};
