...
- Packages esenciales:
  ...
  * babel[spanish, shorthands=off] (idioma)
...
**a) Introducción (1-2 páginas):**
   ...
   - Usar conectores como "o sea", "es decir", "como si"
...
- "O sea, si despejamos..." (informal)
- "Es decir, la distancia entre..." (aclaración)
- "Como sabemos que... entonces..." (consecuencia)
...
5. Recompilar
6. Guardar cambios: `git add . && git commit -m "Agregada Guía [Tema] - Grado [X]" && git push`
...
- [ ] Se incluyen explicaciones coloquiales
...
- LaTeX: TeX Live 2020 o superior
- Compilador: lualatex
...
✅ **Flexible:** Se adapta a diferentes temas matemáticos
...
- Eliminado error tipográfico "Geometría analíticaca"
- Aclarados todos los placeholders [INSERTAR_X]
- Añadidos ejemplos completos de uso
- Mejoradas especificaciones técnicas de TikZ
- Agregada sección de troubleshooting
- Incluida lista de verificación de calidad
- Mejoradas instrucciones de git
