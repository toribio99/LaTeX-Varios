...
\hypersetup{
    ...
    urlcolor=azulclaro,
    pdftitle={Guía de Primer Uso - Sistema Generador de Guías v3.0},
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small Sistema Generador de Guías v3.0}
...
\title{
    ...
    \Large\textbf{\color{azulclaro}Versión 3.0}\\
    \vspace{1cm}
...
¡Bienvenido al Sistema Generador de Guías v3.0! Este tutorial está diseñado especialmente para usuarios que utilizan el sistema por primera vez.
...
\begin{itemize}
    \item \textbf{Versión actual:} 3.0
    \item \textbf{Fecha de lanzamiento:} 2025-11-05
    \item \textbf{Ubicación:} \texttt{Sistema\_Generador\_Guias/}
