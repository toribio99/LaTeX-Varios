...
\draw[gray!30,very thin] (-3,-0.5) grid (3,3.5);
\draw[blue,very thick,domain=-2.5:2.5,samples=100] plot (\x,{sqrt(6.25-\x*\x)});
\draw[red,thick,->] (-2,3.2) -- (-2,0.2);
\draw[red,thick,->] (-1,3.2) -- (-1,0.2);
\draw[red,thick,->] (0,3.2) -- (0,0.2);
\draw[red,thick,->] (1,3.2) -- (1,0.2);
\draw[red,thick,->] (2,3.2) -- (2,0.2);
\end{tikzpicture}
\shorthandon{<>}
...
\draw[blue,very thick] (0,0) circle (2.5);
\draw[red,thick,->] (-2,3.2) -- (-2,-3.2);
\draw[red,thick,->] (-1,3.2) -- (-1,-3.2);
